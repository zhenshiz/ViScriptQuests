...
@NodeAttribute(name = QuestBlueprintNode.ID + "currency_reward", group = QuestBlueprintNode.REWARD_GROUP, graphTypes = QuestBlueprintGraph.class, modID = ViscriptShop.MOD_ID)
