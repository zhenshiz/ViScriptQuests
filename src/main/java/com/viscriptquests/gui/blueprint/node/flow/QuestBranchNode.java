...
// condition 应连接到 CompareNode 的 result 输出，由比较节点提供条件判断
@NodeAttribute(name = "quest_branch", group = QuestBlueprintNode.FLOW_GROUP, graphTypes = QuestBlueprintGraph.class)
